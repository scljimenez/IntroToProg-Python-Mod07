...
![Figure 5 — Printing out the unpickled data from the binary file](scljimenez.github.io/IntroToProg-Python-Mod07/docs/images/pickled_existing_data_to_file.png "The unpickled and printed out data that had been stored in the binary file")
