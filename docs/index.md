...
![Figure 3 — The binary file](https://github.com/scljimenez/IntroToProg-Python-Mod07/blob/main/docs/images/pickled_existing_data_to_file.png?raw=true "Results of opening the binary file in PyCharm")
